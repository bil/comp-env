...
pip install google-api-python-client google-cloud-logging google-auth google-cloud-bigquery google-cloud-logging google-cloud-storage google-cloud-firestore
...
pip install jupyter jupyterlab itables voila
pip install sqlalchemy dask ray modin joblib tables #h5netcdf xarray
pip install bokeh pandas_bokeh seaborn altair ggplot
...
pip install python-dateutil fpdf lxml compress-pickle sqlitedict pipenv simple-slurm
pip install progressbar2 tqdm psutil
pip install python-rclone speedtest-cli
